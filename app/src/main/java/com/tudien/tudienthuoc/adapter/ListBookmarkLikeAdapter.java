...
public class ListBookmarkLikeAdapter extends ArrayAdapter<BookmarkModel> implements ListViewAdapter {
    ...
    private ArrayList<BookmarkModel> list;

    public ListBookmarkLikeAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull ArrayList<BookmarkModel> objects) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final BookmarkModel model = list.get(position);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (MainActivity.MENU_LOAI == null || MainActivity.MENU_LOAI.equals("THUOC")) {
                    ...
                    assetBookmark.deleteLikeThuoc(model.id);
                    TabTatCa.CUSTOM_ADAPTER.clear();
                    TabTatCa.CUSTOM_ADAPTER.addAll(dbAssetThuoc.queryNhomThuoc());
                    TabTatCa.CUSTOM_ADAPTER.notifyDataSetChanged();
                } else {
                    DbAssetBenh assetBenh = new DbAssetBenh(activity);
                    assetBookmark.deleteLikeBenh(model.id);
                    TabTatCaBenh.LIST_LOAI_BENH.clear();
                    TabTatCaBenh.LIST_LOAI_BENH.addAll(assetBenh.queryLoaiBenh());
                    TabTatCaBenh.LIST_LOAI_BENH.notifyDataSetChanged();
                }
                ListBookmarkLikeAdapter.this.remove(model);
                ListBookmarkLikeAdapter.this.notifyDataSetInvalidated();
                ListBookmarkLikeAdapter.this.notifyDataSetChanged();
            }
        });
